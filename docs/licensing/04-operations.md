...
## The five things that will actually happen

### 1. A customer wants to buy (invoice route)

The common path for Indian B2B. They send a PO or ask for a proforma invoice;
they pay by NEFT/RTGS; you issue the key.

```
POST /admin/licenses
{ "name": "Kiran Shah", "email": "kiran@rsinfotech.in",
  "org": "RS Infotech Pvt Ltd", "gstin": "24AABCU…",
  "plan": "business", "features": ["core","boq","email"],
  "seats": 5, "period_months": 12,
...
### 2. "Our trial ran out but we're still evaluating"
...
### 3. "It says all our seats are in use, but we only have 3 computers"
...
### 4. "Prism says my licence couldn't be verified"
