...
from shell.widgets.files_panel import kind_label, size_label
from shell.widgets.panel_base import Page, bucket_for
...
class ArtifactsPanel(Page):
    ...
    def _open_file(self, path: str):
        ...
        # leaves the window.
        from shell.dialogs.preview_dialog import open_preview
