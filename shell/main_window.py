...
from shell.widgets.sidebar import Sidebar
from shell.widgets.home_panel import HomePanel
...
from shell.widgets.settings_panel import SettingsPanel
from shell.widgets.wizard_panel import WizardPanel
from shell.widgets.tour import TourOverlay
from addons.bom.panel import BomPanel
from addons.boq.panel import BoqPanel
from shell.widgets.catalog_panel import CatalogPanel
from addons.email.panel import EmailPanel
from addons.gerber.panel import GerberPanel
from shell.widgets.guide_panel import GuidePanel
from shell.widgets.history_panel import HistoryPanel
from shell.widgets.support_panel import SupportPanel
from shell.widgets.controls import kicker
from shell.widgets.input_panel import InputPanel
from shell.widgets.files_panel import FilesPanel
from shell.widgets.prompt_panel import PromptPanel
from shell.widgets.agents_panel import AgentsPanel
from shell.widgets.output_panel import OutputPanel
from shell.workers import (RouteWorker, AutomationWorker, RecordWorker,
                     InterpretWorker, FindWorker, AuthorizeWorker,
                     FFmpegWorker, UpdateWorker, FollowupRouteWorker,
                     ReelWorker)
import wakeword
from wakeword import WakeWordListener
from shell.dialogs.ai_directory_dialog import AIDirectoryDialog
...
from shell.dialogs.completion_dialog import CompletionDialog
...
class MainWindow(QMainWindow):
    ...
    def _push_active_run(self, stage: str, agent: str):
        ...
        behind it.
        """
        from shell.widgets.agents_panel import STAGE_COPY
    ...
    def _attach_from_drive(self):
        ...
        difference."""
        from shell.dialogs.drive_dialog import DriveDialog
    ...
    def _offer_followup(self, responses: dict, links: dict = None):
        ...
        and folding in any new attachments. The re-done result comes back and
        this can offer another follow-up.
        ...
        try:
            ...
            pass
        from shell.dialogs.followup_dialog import FollowupDialog
        ...
        # Explicit agent name WINS over auto-detect. "give it to Perplexity"
    ...
    def _start_followup_run(self, stage: str, agent: str, prompt: str,
        ...
        # starts while the person is looking at the Artifacts screen (checking
        # what came back) — without this the run proceeds on a hidden workbench
        # and there's no way back to it, the "it went off to a new task and I
        # can't get back" bug. The outer screen is forced to the workbench; the
